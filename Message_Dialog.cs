...
namespace pControlsDev.Dialog
{
    ...
    public partial class Message_Dialog : Form
    {
        ...
        public Message_Dialog(String title = "", String msg = "")
        {
            InitializeComponent();
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                pictureBox1.Image = pControlsDev.Properties.Resources.sign_error;
                lblMensagem.Location = new Point(39, 37);
            }
            else if (_tipoMsgBox == TipoIcoMsgBox.ICO_ALERTA)
            {
                pictureBox1.Image = pControlsDev.Properties.Resources.sign_warning;
                lblMensagem.Location = new Point(39, 37);
            }
            else if (_tipoMsgBox == TipoIcoMsgBox.ICO_SUCESSO)
            {
                pictureBox1.Image = pControlsDev.Properties.Resources.sign_success;
                lblMensagem.Location = new Point(39, 37);
            }
            else
            {
